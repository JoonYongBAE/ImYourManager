...
public class JoinBoardService implements BoardService{
    ...
    public Long write(Object object) {
        JoinBoardDTO joinBoardDTO = (JoinBoardDTO) object;
        JoinBoard joinBoard = modelMapper.map(joinBoardDTO, JoinBoard.class);//joinBoardDTO를 domain으로 변환해준다.
        Long joinBoradNum = joinBoardRepository.save(joinBoard).getJoinBoardNum();//JPA를 사용하여 테이블에 값을 넣어준다.
